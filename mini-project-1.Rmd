...
-   I choose *`apt_buildings`, it have many features to explore, and they have very self-explanatory names. I also like it does not have free text field like in stream_game, so I can factorize most of the column.*
...
-   What is the trend between the `year_built` and `no_of_storeys` of an apartment?
...
2.  Create a new variable based on other variables in your data (only if it makes sense)
    ...
    Using `no_of_units` and `no_of_storeys`, I will create a variable call `average_no_of_units_per_storeys`
...
4.  Investigate how many missing values there are per variable. Can you find a way to plot this?
...
3.  Do social housing have adequate fire safety? (fire alarm, sprinkle system, exterior fire excape)
